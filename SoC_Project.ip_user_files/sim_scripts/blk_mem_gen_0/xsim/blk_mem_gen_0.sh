...
#
# Generated by Vivado on Mon Feb 27 23:40:43 +0100 2023
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L xilinx_vip -L secureip -L xpm --snapshot blk_mem_gen_0 xil_defaultlib.blk_mem_gen_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  blk_mem_gen_0 -key {Behavioral:Simulation:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/zynq_block.protoinst" -log simulate.log
}
