...
HD_PWD='Labor_SoC-Design/SoC_Project/SoC_Project.runs/zynq_block_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_block_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_block_processing_system7_0_0.tcl
